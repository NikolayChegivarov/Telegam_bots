...
## Установка
1 Создать виртульное окруение
2 Убедитесь, что у вас установлены все необходимые зависимости. Для этого выполните команду:
```bash
...
```
3 Создайте пользователя Postgres с правами на создание базы данных. 
База данных и все таблицы бот создаст сам при запуске. 
